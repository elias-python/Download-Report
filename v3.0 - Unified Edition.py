...
class App(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Mosaic Atlas Vision v4.0 - Master")
        ...
        # Carrega as configurações de pasta
        ...
        self.ao_mudar_modo(self.modo_var.get()) # Força a aplicação das cores iniciais
    ...
    def salvar_config(self, caminho_desc=None, caminho_carr=None, ultima_att=None):
    ...
    def ao_mudar_modo(self, valor_selecionado):
        """Muda dinamicamente as cores de toda a interface baseado no modo."""
        ...
        # Aplica a cor aos elementos da interface
        ...
        self.log_text.tag_config("ok", foreground=cor_base) # Muda a cor das mensagens de log
